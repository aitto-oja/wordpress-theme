...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".like-box").on("click", this.myClickDispatcher.bind(this));
  } // Methods
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(aittoojaData.root_url + "/wp-json/aittooja/v1/search?term=" + this.searchField.val(), results => {
      this.resultDiv.html(`
        <div class="row">
          <div class="one-third">
          ...
          <div class="one-third">
            ...
            ${results.projects.length ? '<ul class="link-list min-list">' : `<p>No projects match that search. <a href="${aittoojaData.root_url}/projects">View all projects</a></p>`} 
              ${results.projects.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
            ${results.projects.length ? "</ul>" : ""}
            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length ? "" : `<p>No events match that search. <a href="${aittoojaData.root_url}/events">View all events</a>.</p>`} 
          ...
          <div class="one-third">
            ...
            ${results.languages.length ? '<ul class="professor-cards">' : `<p>No languages match that search.</p>`} 
              ${results.languages.map(item => `
            ...
            ${results.frameworks.length ? '<ul class="professor-cards">' : `<p>No frameworks match that search.</p>`} 
              ${results.frameworks.map(item => `
                    <li class="professor-card__list-item">
                    <a class="professor-card" href="${item.permalink}">
                        <img class="professor-card__image" src="${item.image}">
                        <span class="professor-card__name">
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkreeta_aittooja_theme"] = self["webpackChunkreeta_aittooja_theme"] || [];
